...
exports.mockMessages = exports.mockConversations = exports.currentUser = void 0;
...
function getConversationsByUser(userId) {
    return exports.mockConversations.filter(c => c.participants.some(p => p.id === userId));
}
function getMessagesByConversation(conversationId) {
    return exports.mockMessages[conversationId] || [];
}
function getConversationById(id) {
    return exports.mockConversations.find(c => c.id === id);
}
