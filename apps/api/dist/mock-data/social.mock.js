...
exports.mockRoomShares = exports.mockSocialEvents = void 0;
exports.getEventsByCity = getEventsByCity;
exports.getRoomSharesByCity = getRoomSharesByCity;
exports.getEventById = getEventById;
exports.getRoomShareById = getRoomShareById;
exports.mockSocialEvents = [
    {
        id: 'evt-sh-001',
        title: '周五跳海酒吧趴',
...
function getEventsByCity(city) {
    if (!city || city === 'all')
        return exports.mockSocialEvents;
    return exports.mockSocialEvents.filter(e => e.city.toLowerCase() === city.toLowerCase());
}
function getRoomSharesByCity(city) {
    if (!city || city === 'all')
        return exports.mockRoomShares;
    return exports.mockRoomShares.filter(r => r.city.toLowerCase() === city.toLowerCase());
}
function getEventById(id) {
    return exports.mockSocialEvents.find(e => e.id === id);
}
function getRoomShareById(id) {
    return exports.mockRoomShares.find(r => r.id === id);
}
//# sourceMappingURL=social.mock.js.map