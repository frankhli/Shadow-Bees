...
exports.mockGuides = void 0;
exports.getGuidesByCity = getGuidesByCity;
exports.getGuideById = getGuideById;
exports.getGuidesByLanguage = getGuidesByLanguage;
...
function getGuidesByCity(city) {
    if (!city || city === 'all')
        return exports.mockGuides;
    return exports.mockGuides.filter(g => g.city.toLowerCase() === city.toLowerCase());
}
function getGuideById(id) {
    return exports.mockGuides.find(g => g.id === id);
}
function getGuidesByLanguage(language) {
    if (!language)
        return exports.mockGuides;
    return exports.mockGuides.filter(g => g.languages.includes(language));
}
//# sourceMappingURL=guides.mock.js.map