  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (success) {
        ...
        setError(t('errors.generic', { defaultValue: 'Registration failed, please try again' }))
      }
    } catch (err) {
      setError(t('errors.generic', { defaultValue: 'Registration failed, please try again' }))
    } finally {
            ...
            <form onSubmit={handleSignup} className="space-y-4">
              ...
              <div>
                ...
                {formData.confirmPassword && formData.password !== formData.confirmPassword && (
                  <p className="text-red-500 text-xs mt-1">{t('errors.passwordMatch')}</p>
                )}
              </div>
